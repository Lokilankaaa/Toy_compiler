...
public :
    ...
    Symbol(std::string name, TOY_COMPILER::symbolVal valType, TOY_COMPILER::symbolType symbolType,
           TOY_COMPILER::abstractAST *node, TOY_COMPILER::symbolVal elementType, int beginIndex, int endIndex,
           int scopeIndex);    //add a array with range
    Symbol(std::string name, TOY_COMPILER::symbolVal valType, TOY_COMPILER::symbolType symbolType,
           TOY_COMPILER::abstractAST *node, TOY_COMPILER::symbolVal elementType, int arrayLength,
           int scopeIndex);    //add a array with length
    Symbol(std::string name, TOY_COMPILER::symbolType symbolType, TOY_COMPILER::abstractAST *node, int beginIndex,
           int endIndex, int scopeIndex); //add a range
    Symbol(std::string name, TOY_COMPILER::symbolVal valType, TOY_COMPILER::symbolType symbolType,
           TOY_COMPILER::abstractAST *node, int scopeIndex);    //add a integer/real/boolean/char
    Symbol();
...
public:
    ...
    FunctionSymbol(
            std::string functionName);    //insert a function only with name, add args and result value with functions below
