...
// mark class
    ...
    public:
        varNode(std::string id, abstractTypeDeclNode *inferType)
                : id{std::move(id)}, varType{inferType} {}
    ...
    public:
        ...
        bool isProc() const { return _isProc; }

        bool isSys() const { return _isSys; }
